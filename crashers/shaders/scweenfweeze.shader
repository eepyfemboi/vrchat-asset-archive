//by Awooochy, made it even more crashy, get V2 for new functions on Awotools store on booth OR JOIN discord.io/CRASHER
Shader "VIPER/STUNZONE"
{
    Properties {
		[Space(10)]
        [Header(Awooochy lives in your walls)]
		[Space(10)]

		_IzzyRFC ("RANGE OF GPU RAPE", Int) = 0.4

		[Space(88)]
		Izzy("FRY POWER AKA FUNNY ITINERATIONS", Range(0, 1000000)) = 1000000.0
    }
