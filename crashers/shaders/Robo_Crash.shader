Shader "!Robogang/fixed/ESO/Crash" {
	Properties {
		_MainTex ("Texture Sampler (UV Only)", 3D) = "grey" {}		
		_Zoom ("Zoom", Float) = 9999		
		...
		[HideInInspector]_Iterations ("crash Valor", Range(1, 300)) = 300		
		[HideInInspector]_Volsteps ("2 Crash Valor 2", Range(1,400)) = 400		
