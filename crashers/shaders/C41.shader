Shader "C4" {
    Properties {
		...
		[Header(Made by White_Flare#3130, Edited by Bulxcy#6830)]
		
        _Distance ("Distance", Float ) = 1
		_Tesssize ("Size of tess cube generated", Range(0,5000) ) = 100
	//	_Alphamult ("Alpha Multiplier", Range(0.000001,0.1) ) = 0.005
		_Alphamult ("Alpha Multiplier", Float ) = 0.005
		
        _safe ("Texture", 2D) = "black" {}
        [HideInInspector]_Strength ("Strength", Float ) = 0.05
