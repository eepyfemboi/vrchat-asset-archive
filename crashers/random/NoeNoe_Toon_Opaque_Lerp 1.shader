...
Shader "NoeNoe/NoeNoe Toon Shader/NoeNoe Toon Opaque" {
    Properties {
        ...
        _TextureLerp ("Texture Lerp", Range(0, 1)) = 0.0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _MainTex_var = lerp(tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex)), tex2D(_SecondaryTex,TRANSFORM_TEX(i.uv0, _SecondaryTex)), _TextureLerp);
