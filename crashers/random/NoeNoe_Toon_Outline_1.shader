...
////// Emissive:
                ...
                float node_424 = 0.5;
                float3 node_2136 = (normalDirection*faceSign);
                ...
                float node_1617 = 0.5*dot(node_2136,StaticLightDirection)+0.5;
                ...
                float3 node_3893 = StaticToonLighting;
                float3 finalColor = emissive + saturate(((_Intensity*FlatLighting*Diffuse) > 0.5 ?  (1.0-(1.0-2.0*((_Intensity*FlatLighting*Diffuse)-0.5))*(1.0-lerp(float3(node_424,node_424,node_424),node_3893,_ToonContrast))) : (2.0*(_Intensity*FlatLighting*Diffuse)*lerp(float3(node_424,node_424,node_424),node_3893,_ToonContrast))) );
...
////// Lighting:
                ...
                float3 StaticToonLighting = node_9498.rgb;
                float3 node_3893 = StaticToonLighting;
                float3 finalColor = saturate(((_Intensity*FlatLighting*Diffuse) > 0.5 ?  (1.0-(1.0-2.0*((_Intensity*FlatLighting*Diffuse)-0.5))*(1.0-lerp(float3(node_424,node_424,node_424),node_3893,_ToonContrast))) : (2.0*(_Intensity*FlatLighting*Diffuse)*lerp(float3(node_424,node_424,node_424),node_3893,_ToonContrast))) );
