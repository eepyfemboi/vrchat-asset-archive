...
////// Emissive:
                ...
                return fixed4(finalColor,(SurfaceAlpha*_Opacity));
            }
            ENDCG
        }
        Pass {
...
////// Lighting:
                ...
                float SurfaceAlpha = _MainTex_var.a;
                return fixed4(finalColor * (SurfaceAlpha*_Opacity),0);
            }
            ENDCG
        }
        Pass {
