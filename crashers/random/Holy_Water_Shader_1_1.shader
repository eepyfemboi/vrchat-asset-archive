...
//Original name Seascape Shader
//translated from GLSL to CG by Przemyslaw Zaworski



Shader "God's Children/Holy Water Shader"
{
	Subshader
	{cull off
		Pass
		{
			...
			{
				v2f o;
				o.screen_space_vertex = UnityObjectToClipPos(vertex);
				o.world_space_vertex = mul(unity_ObjectToWorld, vertex).xyz; 
				return o;
			}
