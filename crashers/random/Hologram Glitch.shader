...
Shader "Bender's Shaders/Special FX/Hologram Glitch" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _HologramStrength;
            struct VertexInput {
...
////// Lighting:
////// Emissive:
                float3 emissive = lerp( (_TexHoloColor.rgb+_ColorStrength), (_TexHoloColor.rgb*_ColorStrength), _SaturateTint );
                float3 finalColor = emissive;
                return fixed4(finalColor,_HologramStrength);
            }
            ENDCG
        }
        Pass {
