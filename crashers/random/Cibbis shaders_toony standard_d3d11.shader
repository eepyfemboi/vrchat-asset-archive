...
_IndirectColor ("Color", Color) = (0.7,0.7,0.7,1)
...
_SpMode ("__SpMode", Float) = 0
_IndirectSpecular ("__IndirectSpecular", Float) = 0
_Workflow ("__Workflow", Float) = 0
_SrcBlend ("__src", Float) = 1
_DstBlend ("__dst", Float) = 0
_ZWrite ("__zw", Float) = 1
_ToonyHighlights ("__ToonyHighlights", Float) = 0
_FakeLight ("__FakeLight", Float) = 0
_OcclusionOffset ("_-OcclusionOffset", Float) = 0
_EnableSpecular ("__EnableSpecular", Float) = 0
_DetailMap ("__DetailMap", Float) = 0
_ToonRampBox ("__ToonRampBox", Float) = 0
_RimLightBox ("__RimLightBox", Float) = 0
_SpecularBox ("__SpecularBox", Float) = 0
_DetailBox ("__DetailBox", Float) = 0
}
SubShader {
 LOD 200
