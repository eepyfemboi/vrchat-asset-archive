		...
		Pass {
			...
			Program "vp" {
				SubProgram "d3d11 " {
					...
					mul o1.xyz, r0.xyzx, cb0[3].xxxx
					mov o1.w, r0.w
					mad o2.xy, v2.xyxx, cb0[4].xyxx, cb0[4].zwzz
					ret 
				...
				SubProgram "d3d11 " {
					...
					mov o0.xyzw, r2.xyzw
					mul r3.xyzw, v1.xyzw, cb0[2].xyzw
					mul o1.xyz, r3.xyzx, cb0[3].xxxx
					mov o1.w, r3.w
					mad o2.xy, v2.xyxx, cb0[4].xyxx, cb0[4].zwzz
