Shader "Naelstrof/BlendShape Skin"
{
	Properties
	{
		_Color ("Color", Color) = (1,1,1,1)
		_SubSurfaceColor ("Sub-Surface Color", Color) = (1,1,1,1)
        ...
        _Transmission ("Transmission", Range(0, 1)) = 0.09
        _Emission ("Emission", Range(0, 1)) = 0
        _SpecularMultiplier ("Specular Multiplier", Range(0, 1)) = 0.1
        ...
        _Distortion ("Sub-Surface Distortion ", Range(0, 1)) = 0.8
        _Scale ("Sub-Surface Scale", Range(0, 1)) = 0.4
	}
	SubShader
	{
		...
		Pass {
            ...
            #include "SubsurfaceScatter.cginc"
            struct VertexInput {
...
///////// Gloss:
                ...
                float gloss = (_SpecGlossMap_var.g*_GlossMapScale);
                float perceptualRoughness = 1.0 - (_SpecGlossMap_var.g*_GlossMapScale);
...
/////// Diffuse:
                ...
                float node_572 = _Transmission;
                float3 backLight = max(0.0, -NdotL ) * float3(node_572,node_572,node_572);
                ...
                diffuse = LightingStandardTranslucent(diffuse.rgb, viewDirection.xyz, normalDirection.xyz, lightDirection.xyz, gi.light.color.rgb*_SubSurfaceColor, _Thickness, TRANSFORM_TEX(i.uv0, _Thickness));
////// Emissive:
...
/////// Diffuse:
                ...
                diffuse = LightingStandardTranslucent(diffuse.rgb, viewDirection.xyz, normalDirection.xyz, lightDirection.xyz, _SubSurfaceColor, _Thickness, TRANSFORM_TEX(i.uv0, _Thickness));
/// Final Color:
